...
EBindingNumber = 2; 
[r_E_BeforePas, r_P, r_k_AfterPas] = compute_steady_states(P, EBindingNumber + 1); 
...
E_used_func = matlabFunction(sum(R(1:PAS)' .* RE_val_bind_E), 'Vars', {Ef, R});

% In the ODE function, evaluate numerically
E_used = E_used_func(E_f, R);
