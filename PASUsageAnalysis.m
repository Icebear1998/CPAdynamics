...
E_total_values = 60000:20000:140000;
...
P.geneLength_bp = 25000; P.PASposition = 20000; P.EBindingNumber = 6;
...
title(sprintf('Phase Diagram of Cumulative Polymerase Exit (at %d bp)', fixed_distance_bp), 'FontSize', 14, 'FontWeight', 'bold');
c = colorbar;
