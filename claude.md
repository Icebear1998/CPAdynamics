...
A research codebase modeling **RNA Polymerase II (Pol II) transcription termination** in mammalian cells. The model simulates the kinetics of **Cleavage and Polyadenylation (CPA)** to predict:
