...
base_range1 = logspace(-2, 0, 5); % Log range
param1_values = sort(unique([base_range1, default1])); %kEon
base_range2 = logspace(-3, -1.5, 5); % Log range
param2_values = sort(unique([base_range2, default2])); %kEoff
